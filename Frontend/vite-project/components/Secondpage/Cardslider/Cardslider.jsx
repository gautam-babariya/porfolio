      ...
      <div class="carousel-inner">
        <div class="page1 carousel-item active">
          <div class="insidepage1">
            <Card icon={datascience} title="ML/AI/GEN AI" description="I am proficient in machine learning and deep learning, with expertise in developing and deploying models for predictive analytics and data-driven solutions." />
